...
export default function Value() {
  ...
  return (
    <motion.div
      className="flex justify-center pt-[200px] items-center flex-col w-[100vw] bg-[#181414]"
      initial="hidden"
      animate="visible"
    ...
    >
      <div className="flex justify-center items-center flex-col max-w-[1160px]">
        ...
        <motion.div
          className="flex font-montserrat mt-[40px] mb-[40px] w-[80vw] xl:w-[100vw] items-center justify-center font-semibold text-[16px] text-[#777] text-center"
          variants={itemVariants}
        >
          {isEnglish ? (
            <strong>
